      ...
      <View className="flex-1 p-5">
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          <GlassCard className="mb-6">
            ...
            <View className="pl-2">
              <Text className="text-slate-300 text-sm mb-2">• Navigate to the <Text className="font-bold text-primary">Routes</Text> section from the Home screen.</Text>
              <Text className="text-slate-300 text-sm mb-2">• Click the <Text className="font-bold text-[#059669]">Add New Route</Text> button at the bottom of the list.</Text>
              ...
              <Text className="text-slate-300 text-sm mb-2">• Click <Text className="font-bold text-primary">Create Route</Text>.</Text>
            </View>
          </GlassCard>
          ...
          <GlassCard className="mb-6">
            ...
            <Text className="text-white font-bold mb-2">Step-by-Step Guide:</Text>
            <View className="pl-2">
              <Text className="text-slate-300 text-sm mb-2">• Open the <Text className="font-bold text-primary">Routes</Text> list and find your newly created route.</Text>
              ...
              <Text className="text-slate-300 text-sm mb-2">• Click the <Text className="font-bold text-[#059669]">Add Stop</Text> button.</Text>
          ...
          <GlassCard className="mb-6">
            ...
            <Text className="text-white font-bold mb-2">Step-by-Step Guide:</Text>
            <View className="pl-2">
              <Text className="text-slate-300 text-sm mb-2">• Go to the <Text className="font-bold text-[#d97706]">Buses</Text> section.</Text>
              <Text className="text-slate-300 text-sm mb-2">• Click <Text className="font-bold text-[#059669]">Add New Bus</Text>.</Text>
              ...
              <Text className="text-slate-300 text-sm mb-2">• To temporarily pause operations for a bus, set its status to <Text className="font-bold text-[#d97706]">Maintenance</Text>.</Text>
            </View>
          </GlassCard>
          ...
          <GlassCard className="mb-6">
            ...
            <Text className="text-white font-bold mb-2">Step-by-Step Guide:</Text>
            <View className="pl-2">
              <Text className="text-slate-300 text-sm mb-2">• Go to the <Text className="font-bold text-[#db2777]">Schedules</Text> section.</Text>
              <Text className="text-slate-300 text-sm mb-2">• Click <Text className="font-bold text-[#059669]">Add New Schedule</Text>.</Text>
          ...
          <GlassCard className="mb-6">
            ...
            <View className="pl-2">
              <Text className="text-slate-300 text-sm mb-2">• Navigate to the <Text className="font-bold text-[#059669]">Bookings</Text> tab.</Text>
